...
public enum ExecutionState {
    ...
    FAILURE,
    /** The groovy.de.dkfz.tbi.otp.job.processing.Job has been restarted manually. The only allowed state before is FAILURE*/
    RESTARTED,
    /** The execution of the groovy.de.dkfz.tbi.otp.job.processing.Job has been suspended for a save shutdown. This state is only allowed after STARTED or RESTARTED or RESUMED*/
    SUSPENDED,
