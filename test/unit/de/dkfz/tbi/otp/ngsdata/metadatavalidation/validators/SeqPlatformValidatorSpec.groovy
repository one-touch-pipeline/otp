    ...
    void 'without kit column, validate adds expected problems'() {
        ...
        Collection<Problem> expectedProblems = [
                ...
                new Problem(context.spreadsheet.dataRows[0].cells as Set, Level.ERROR,
                        "The combination of instrument platform 'Platform1', instrument model 'Model1' and sequencing kit 'null' is not registered in the OTP database."),
                new Problem(context.spreadsheet.dataRows[1].cells as Set, Level.ERROR,
                        "The combination of instrument platform 'Platform2', instrument model 'Model1' and sequencing kit 'null' is not registered in the OTP database."),
                new Problem(context.spreadsheet.dataRows[2].cells as Set, Level.ERROR,
                        "The combination of instrument platform 'Platform1', instrument model 'Model2' and sequencing kit 'null' is not registered in the OTP database."),
                new Problem(context.spreadsheet.dataRows[5].cells as Set, Level.ERROR,
                        "The combination of instrument platform 'Platform4', instrument model 'Model3' and sequencing kit 'null' is not registered in the OTP database."),
                new Problem(context.spreadsheet.dataRows[6].cells as Set, Level.ERROR,
                        "The combination of instrument platform 'Platform3', instrument model 'Model4' and sequencing kit 'null' is not registered in the OTP database."),
                new Problem(context.spreadsheet.dataRows[7].cells as Set, Level.ERROR,
                        "The combination of instrument platform 'Platform5', instrument model 'Model3' and sequencing kit 'null' is not registered in the OTP database."),
                new Problem(context.spreadsheet.dataRows[8].cells as Set, Level.ERROR,
                        "The combination of instrument platform 'Platform3', instrument model 'Model5' and sequencing kit 'null' is not registered in the OTP database."),
        ]
