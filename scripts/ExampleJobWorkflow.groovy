...
ParameterType type = new ParameterType(name: "directory", jobDefinition: definition, usage: ParameterUsage.INPUT)
assert(type.save())
Parameter parameter = new Parameter(type: type, value: "/tmp/otp/start")
assert(parameter.save())
ParameterType tarParameterType = new ParameterType(name: "file", jobDefinition: definition, usage: ParameterUsage.OUTPUT)
...
ParameterType unzipOutputDirectoryType = new ParameterType(name: "directory", jobDefinition: unzipJob, usage: ParameterUsage.INPUT)
assert(unzipOutputDirectoryType.save())
ParameterType zipFileType = new ParameterType(name: "zipFile", jobDefinition: unzipJob, usage: ParameterUsage.INPUT)
assert(zipFileType.save())
ParameterType unzipFileType = new ParameterType(name: "unzipFile", jobDefinition: unzipJob, usage: ParameterUsage.OUTPUT)
...
ParameterType directoryType = new ParameterType(name: "directory", jobDefinition: untarJob, usage: ParameterUsage.INPUT)
assert(directoryType.save())
ParameterType fileNameType = new ParameterType(name: "file", jobDefinition: untarJob, usage: ParameterUsage.INPUT)
assert(fileNameType.save())
ParameterType outputFilesType = new ParameterType(name: "extractedFiles", jobDefinition: untarJob, usage: ParameterUsage.OUTPUT)
...
assert(untarJob.save())
ParameterType fileNamePassthroughType = new ParameterType(name: "fileNamePassthrough", jobDefinition: untarJob, usage: ParameterUsage.PASSTHROUGH)
...
ParameterType tarInputFilesType = new ParameterType(name: "files", jobDefinition: tarJob, usage: ParameterUsage.INPUT)
assert(tarInputFilesType.save())
ParameterType tarTargetDirectoryType = new ParameterType(name: "directory", jobDefinition: tarJob, usage: ParameterUsage.INPUT)
assert(tarTargetDirectoryType.save())
ParameterType outputTarFileType = new ParameterType(name: "tarFile", jobDefinition: tarJob, usage: ParameterUsage.OUTPUT)
...
assert(tarJob.save())
ParameterType fileNamePassthrough2Type = new ParameterType(name: "fileNamePassthrough", jobDefinition: tarJob, usage: ParameterUsage.PASSTHROUGH)
...
ParameterType fileCheck1Type = new ParameterType(name: "file", jobDefinition: md5sum1Job, usage: ParameterUsage.INPUT)
assert(fileCheck1Type.save())
ParameterType md5Sum1Type = new ParameterType(name: "md5sum", jobDefinition: md5sum1Job, usage: ParameterUsage.OUTPUT)
assert(md5Sum1Type.save())
ParameterType fileNamePassthrough3Type = new ParameterType(name: "fileNamePassThrough", jobDefinition: md5sum1Job, usage: ParameterUsage.PASSTHROUGH)
...
ParameterType fileCheck2Type = new ParameterType(name: "file", jobDefinition: md5sum2Job, usage: ParameterUsage.INPUT)
assert(fileCheck2Type.save())
ParameterType md5Sum2Type = new ParameterType(name: "md5sum", jobDefinition: md5sum2Job, usage: ParameterUsage.OUTPUT)
assert(md5Sum2Type.save())
ParameterType md5Sum2PassthroughType = new ParameterType(name: "passthrough", jobDefinition: md5sum2Job, usage: ParameterUsage.PASSTHROUGH)
...
ParameterType compare1Type = new ParameterType(name: "value1", jobDefinition: compareJob, usage: ParameterUsage.INPUT)
assert(compare1Type.save())
ParameterType compare2Type = new ParameterType(name: "value2", jobDefinition: compareJob, usage: ParameterUsage.INPUT)
