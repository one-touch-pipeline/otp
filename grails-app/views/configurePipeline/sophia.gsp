...
<head>
    ...
    <title><g:message code="configurePipeline.sophia.title" args="[project.name, seqType.displayName]"/></title>
</head>
<body>
    <div class="body">
        <h1><g:message code="configurePipeline.sophia.title" args="[project.name, seqType.displayName]"/></h1>
        <g:if test="${hasErrors}">
        ...
        <g:form controller="configurePipeline" action="sophia" params='["project.id": project.id, "seqType.id": seqType.id]'>
