...
class TransferMergedBamFileWorkflowTests extends GroovyScriptAwareIntegrationTest {
     ...
     *    sudo chown $USER STORAGE_ROOT/dmg/otp/test/TransferWorkflow
    ...
    String qaResultOverviewFile = "${destinationDirQaResults}/QAResultOverview.tsv"
    String qaResultOverviewExtendedFile = "${destinationDirQaResults}/QAResultOverviewExtended.tsv"
    /**
    ...
    boolean waitUntilWorkflowIsOverOrTimeout(int timeout) {
        // FIXME: just checks for finished, not successful
