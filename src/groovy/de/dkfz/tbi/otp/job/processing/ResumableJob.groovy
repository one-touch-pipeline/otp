...
/**
 * Annotation for any groovy.de.dkfz.tbi.otp.job.processing.Job that can be suspended and resumed safely.
 *
 ...
 * other.
 *
 * By default the framework assumes that no groovy.de.dkfz.tbi.otp.job.processing.Job can be resumed. This means when the application
