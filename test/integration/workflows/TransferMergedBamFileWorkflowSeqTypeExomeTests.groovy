...
class TransferMergedBamFileWorkflowSeqTypeExomeTests extends WorkflowTestCase {
    ...
    void setUp() {
        ...
        fileNameMergedBamFile2 = "${filePathMergedBamFile2}control_pid_1_EXON_PAIRED_merged.mdup.bam"
        filePathBaiFile1 = "${mergingMiddleDir}/0/pass0/"
        fileNameBaiFile1 = "${filePathBaiFile1}control_pid_1_EXON_PAIRED_merged.mdup.bai"
        filePathBaiFile2 = "${mergingMiddleDir}/1/pass0/"
        fileNameBaiFile2 = "${filePathBaiFile2}control_pid_1_EXON_PAIRED_merged.mdup.bai"
