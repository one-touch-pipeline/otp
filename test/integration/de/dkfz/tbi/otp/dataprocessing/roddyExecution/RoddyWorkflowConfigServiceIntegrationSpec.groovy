...
class RoddyWorkflowConfigServiceIntegrationSpec extends Specification {
    ...
    static final String TEST_RODDY_CONFIG_FILE_NAME = "${Pipeline.Name.PANCAN_ALIGNMENT.name()}_${TEST_RODDY_SEQ_TYPE_RODDY_NAME}_${SeqType.LIBRARYLAYOUT_SINGLE}_${TEST_RODDY_PLUGIN_VERSION_VERSION_PART}_${DomainFactory.TEST_CONFIG_VERSION}.xml"
    static final String TEST_RODDY_CONFIG_FILE_NAME_PLUGIN_VERSION_2 = "${Pipeline.Name.PANCAN_ALIGNMENT.name()}_${TEST_RODDY_SEQ_TYPE_RODDY_NAME}_${SeqType.LIBRARYLAYOUT_SINGLE}_${TEST_RODDY_PLUGIN_VERSION_VERSION_PART_2}_${DomainFactory.TEST_CONFIG_VERSION}.xml"
    static final String TEST_RODDY_CONFIG_LABEL_IN_FILE = "${Pipeline.Name.PANCAN_ALIGNMENT.name()}_${TEST_RODDY_SEQ_TYPE_RODDY_NAME}_${SeqType.LIBRARYLAYOUT_SINGLE}_${TEST_RODDY_PLUGIN_VERSION}_${DomainFactory.TEST_CONFIG_VERSION}"
